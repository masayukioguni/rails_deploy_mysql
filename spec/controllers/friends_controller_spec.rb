  ...
  describe "POST create" do
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved friend as @friend" do
        ...
        post :create, {:friend => { "name" => "invalid value" }}, valid_session
        assigns(:friend).should be_a_new(Friend)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested friend" do
        ...
        Friend.any_instance.should_receive(:update).with({ "name" => "MyString" })
        put :update, {:id => friend.to_param, :friend => { "name" => "MyString" }}, valid_session
      end
    ...
    describe "with invalid params" do
      it "assigns the friend as @friend" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        Friend.any_instance.stub(:save).and_return(false)
        put :update, {:id => friend.to_param, :friend => { "name" => "invalid value" }}, valid_session
        assigns(:friend).should eq(friend)
      end
